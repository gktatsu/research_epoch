...
このスクリプトは、MAT形式のデータをH5形式に変換するためのツールです。
Human3.6MやMPI-INF-3DHPなどのデータセットで使用されるMATファイルを、
H5形式に変換することで、データの取り扱いを容易にします。

主な機能:
- 単一のMATファイルをH5形式に変換
- ディレクトリ内のすべてのMATファイルを再帰的に処理
- データセットの種類に応じた変換処理を実行
